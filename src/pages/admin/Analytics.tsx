...
export function Analytics() {
  ...
  return (
    <div className="p-8 space-y-6 bg-slate-50 dark:bg-slate-900 min-h-screen">
      <div><h1 className="text-3xl font-bold text-slate-900 dark:text-white">Analytics Dashboard</h1><p className="text-slate-600 dark:text-slate-400 mt-2 font-medium">Website performance and SEO metrics</p></div>
